...
[Given genotypes of parents or genotype of one parent, predict progeny's random genotype](Given genotypes of parents or genotype of one parent, predict progeny's random genotype "predict_progeny_genotype_MAF.md")  
...
[Drop the first or the last element(s) of text strings](Drop the first or the last element(s) of text strings "drop_1st_last_string.md")  
...
[Capturing Rscript errors in an output file](Capturing Rscript errors in an output file "capture_error.md")  
